...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	studioFileStorage, err := service.ProvideStudioFileStorage(configConfig)
	if err != nil {
		return nil, err
	}
